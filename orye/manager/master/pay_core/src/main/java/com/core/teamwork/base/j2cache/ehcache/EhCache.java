...
public class EhCache implements Cache, CacheEventListener {
	...
	@Override
	public void putExpire(Object key, Object value,Integer timeToLiveSeconds) throws CacheException {
		// TODO Auto-generated method stub
		try {
			Element element = new Element(key, value, null, null, timeToLiveSeconds);
			cache.put( element );
		}
		catch (IllegalArgumentException e) {
			throw new CacheException( e );
