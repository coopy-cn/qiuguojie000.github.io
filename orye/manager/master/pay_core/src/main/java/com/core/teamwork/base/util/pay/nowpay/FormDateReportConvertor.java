package com.core.teamwork.base.util.pay.nowpay;
...
public class FormDateReportConvertor {
     ...
     */
    public static Map<String,String> parseFormDataPatternReportWithDecode(String reportContent,String reportCharset,String targetCharset) throws UnsupportedEncodingException {
     ...
     * @return
     */
    public static String reportSort(String reportContent) {
        if(reportContent == null || reportContent.length()==0) return null;

        Map<String,String> key_value_map = parseFormDataPatternReport(reportContent);
        Set<String> keySet = key_value_map.keySet();
        ...
        return toMD5StringBuilder.toString();
    }
}
