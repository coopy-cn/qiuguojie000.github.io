    ...
    public static File createCSVFile(List exportData, LinkedHashMap map, String outPutPath,  
        ...
        try {  
            ...
            csvFileOutputStream = new BufferedWriter(new OutputStreamWriter(new FileOutputStream(  
                csvFile), "GBK"), 1024);  
            csvFileOutputStream.write("#平台业务明细查询\r\n"); 
...
//                            	textValue="\""+textValue+"\"";  
    ...
    public static void main(String[] args) {  
    	...
    	/*Object[] headers = { "平台订单号", "商户订单号", "来源商户", "来源应用", "支付渠道", "订单金额(元)", "实际支付金额(元)", "优惠金额(元)", "退款金额(元)", "订单状态", "创建时间", "订单支付时间", "订单回调时间" };
...
//		FtpUploadClient c =  new FtpUploadClient("192.168.1.14", 210, "---", "---", "/yizhan/aizichan/");
