package com.orye.manger.controller;
...
import com.orye.manger.log.SessionVO;
...
public class InterfaceBaseController {
	...
	protected HttpSession getSessionById(String sessionId, boolean create) {
		...
		if (session == null) {// 如果缓存没有就从redis中取
			...
			if (session != null) {
				...
				request.setAttribute(SESSION_ID_PARA_NAME, session.getId());
	...
	public HttpSession getSession() {
		...
		sessionId = request.getParameter(SESSION_ID_PARA_NAME);
		if (sessionId == null) {
