package com.orye.manger.ExportExcel;
        ...
        if (null != data) {  
            ...
            for (int i = 0; i < data.size(); i++) {  
                ...
                for (int j = 0; j < matchColNamesMapArr.length; j++) {
                	textValue = data.get(i).get(matchColNamesMapArr[j])==null?"":data.get(i).get(matchColNamesMapArr[j]).toString();
                	//如果有逗号  
